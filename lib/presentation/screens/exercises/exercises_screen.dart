              ...
              child: InkWell(
                onTap: () {
                  ExerciseViewModel model = ExerciseViewModel(
                    cubit.musclesExercise.keys.elementAt(index),
                    cubit.musclesExercise.values.elementAt(index),
                    cubit.secondaryMusclesExercise.values.elementAt(index),
                  );
                  Navigator.of(context)
                      .pushNamed(musclesExercisesScreen, arguments: model);
                },
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      DefaultText(
                        text:
                            cubit.musclesExercise.keys.elementAt(index).nameEn,
                        fontSize: 16.sp,
                      ...
                      FadeTransition(
                        ...
                        child: Stack(
                          children: [
                            Visibility(
                              visible: cubit.musclesExercise.keys
                                  .elementAt(index)
                                  .isFront,
                            ...
                            DefaultSVG(
                                height: 85.sp,
                                imagePath: cubit.musclesExercise.keys
                                    .elementAt(index)
                                    .imageUrlMain)
                          ],
                        ),
